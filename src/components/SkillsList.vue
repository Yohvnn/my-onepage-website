    ...
    <ul class="text-gray-600 dark:text-gray-200">
      ...
      <li class="mb-4">
        <div class="flex space-x-4">
          <span class="w-64 font-semibold">Programming & Data Science</span>
      ...
      <li class="mb-4">
        <div class="flex space-x-4">
          <span class="w-64 font-semibold">Databases & Data Management</span>
      ...
      <li class="mb-4">
        <div class="flex space-x-4">
          <span class="w-64 font-semibold">Web Development & Systems</span>
      ...
      <li class="mb-4">
        <div class="flex space-x-4">
          <span class="w-64 font-semibold">Media & Design</span>
      ...
      <li class="mb-4">
        <div class="flex space-x-4">
          <span class="w-64 font-semibold">Documentation & Office Tools</span>
      ...
      <li class="mb-4">
        <div class="flex space-x-4">
          <span class="w-64 font-semibold">GIS</span>
          <span>QGIS</span>
        </div>
      </li>
